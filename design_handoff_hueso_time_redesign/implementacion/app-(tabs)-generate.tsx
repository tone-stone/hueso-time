...
import type { Genre, SetBlock, Song, SongFilters } from '@/types/models';
...
export default function GenerateScreen() {
  ...
  const { songs, songsById, setlists, settings, upsertSetlist } = useApp();
  ...
  const row = (
    ...
    <Pressable
      ...
      <Text style={[styles.rowIcon, { color: c.tint }]}>{icon}</Text>
          ...
          <View style={[styles.pad, desktop && styles.padDesktop]}>
            <View style={styles.triggerWrap}>
              <Pressable
                ...
                />
                <Text style={[styles.triggerIcon, { color: c.tint }]}>⤨</Text>
